/* ------------------------------------------------------------
   V35__exclude_inactive_from_consensus_view.sql
   Recreate v_latest_screener_consensus to exclude inactive stocks
   (dim_stock.is_active = false) at the SQL level.
   ------------------------------------------------------------ */
